...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-rcpparmadillo-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rcpparmadillo-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-rcpparmadillo
# for installing globally
pixi global install r-rcpparmadillo
```
...
It is possible to list all of the versions of `r-rcpparmadillo` available on your platform:
...
```
pixi search r-rcpparmadillo --channel conda-forge
```
